...
versions <- tibble(
  ...
  vlabel = factor(
    ...
    "$P(S_1|untested)$ and $\\beta$ Centered at Emp. Values",
        ...
        "$\\,$CTIS Priors that Do Not Vary by Date$\\,$"
    ),
    levels = c(
...
Although the spline-smoothing improved the correlations, it did not improve the proportion containing the Covidestim median. 
