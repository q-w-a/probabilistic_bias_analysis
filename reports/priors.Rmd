...
```{r s-untested-smoothing, fig.cap="The percentage of the population experiencing COVID-19-like illness is taken to be the estimate of $\\Pr(S_1|\\text{untested}). The LOESS smoothed estimate with a span of 0.2 is shown in red."}
