...
include_graphics(here('figures/testing_rate_ratio-county.pdf'))
...
county_coverage %>%
  ...
  footnote(general = "The percent of simulation intervals where the Covidestim median falls below, within, or above the interval, when considering all simulation intervals for that implementation and geographic scale.", general_title ="", footnote_as_chunk=TRUE, threeparttable=TRUE)
